...
resource "azurerm_public_ip" "ExistingNetworkRG" {
   name                         = "swarm-manager01-RG-TF-VM-Network"
...
resource "azurerm_virtual_machine" "ExistingNetworkRG" {
 name                  = "swarm-manager01"     # This is the VM Name in Azure Portal
...
*/
 ...
 os_profile {
   computer_name  = "swarm-manager01"  # This is the OS name - login prompt
 ...
 tags = {
       environment = "Terraform Project - centos 7.7 Gen2"
