...
resource "azurerm_public_ip" "ExistingNetworkRG" {
   name                         = "docker-registry-RG-TF-VM-Network"
...
resource "azurerm_virtual_machine" "ExistingNetworkRG" {
 name                  = "docker-registry"     # This is the VM Name in Azure Portal
...
*/
 ...
 os_profile {
   computer_name  = "docker-registry"  # This is the OS name - login prompt
